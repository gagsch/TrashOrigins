...
import xyz.gagsch.trashorigins.power.allay.CompanionPower;
import xyz.gagsch.trashorigins.power.allay.MusicFlightPower;
...
public class Powers {
    ...
    public static final RegistryObject<MusicFlightPower> MUSIC_FLIGHT = POWER_FACTORIES.register("music_flight", MusicFlightPower::new);
    public static final RegistryObject<CompanionPower> COMPANION_POWER = POWER_FACTORIES.register("companion", CompanionPower::new);
    ...
    public static final ResourceLocation MUSIC_CHARGE_LOCATION = TrashOrigins.identifier("allay/music_charge");
